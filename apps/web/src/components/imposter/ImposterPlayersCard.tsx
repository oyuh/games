        ...
        {players.map((player) => {
          ...
          return (
            <div
              ...
              data-tooltip={`${name}${!player.connected ? " (disconnected)" : ""}${isEliminated ? " — Eliminated" : ""}${isImposter ? " — Imposter!" : revealRoles ? " — Innocent" : ""}`}
              data-tooltip-variant={isEliminated ? "warning" : isImposter ? "danger" : revealRoles ? "success" : "info"}
            >
